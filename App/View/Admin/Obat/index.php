        ...
        ?>
            <tr>
                ...
                <td width="10%" class="text-center">
                    <?= $data['stok'] ?>
                    <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $data['id_obat']?>">
                        <img src="<?= BASEURL ?>/App/Image/Icon/edit.png" alt="" width="20" height="20">
                    </button>
                </td>
                <td width="15%" class="">
                    <center>
            ...
            <div class="modal fade" id="exampleModal<?= $data['id_obat']?>" tabindex="-1" aria-labelledby="exampleModal<?= $data['id_obat']?>Label" aria-hidden="true">
                <div class="modal-dialog">  
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModal<?= $data['id_obat']?>Label">Ubah Stok</h5>
                        ...
                        <form class="row g-3 needs-validation p-3" method="post" novalidate>
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="submitButton" name="submitButton" type="submit" class="btn btn-primary">Tambah</button>
                            </div>
                        </form>
                    </div>
                </div>
